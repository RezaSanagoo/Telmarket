...
const Button = () => {
  return (
    <button className="relative flex items-center px-0 py-3 overflow-hidden font-medium transition-all bg-indigo-500 h-[42px] rounded rounded-ee-xl group justify-center max-w-[45%] w-full">
